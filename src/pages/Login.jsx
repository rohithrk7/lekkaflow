      ...
      <div className="w-full max-w-[460px] relative z-10">
        <div className="bg-white rounded-[48px] shadow-[0_32px_80px_-16px_rgba(0,0,0,0.12)] border border-gray-100 p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="relative my-10 text-center">
            ...
            <span className="relative px-4 bg-white text-gray-300 text-[10px] font-black uppercase tracking-widest">Advanced Login</span>
          </div>

          <button
            onClick={loginWithGoogle}
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-50 py-4.5 px-6 rounded-2xl font-black text-gray-700 shadow-sm hover:border-primary/10 transition-all duration-300 active:scale-95 group"
          >
